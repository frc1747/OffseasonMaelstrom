...
import frc.robot.commands.autos.AutoPivot;
import frc.robot.commands.autos.ElevatorAutoCommand;
    ...
    private SendableChooser<Command> autoChooser;  
      ...
      public RobotContainer() {
       // Auto Commands 
        ...
        NamedCommands.registerCommand("EleL4", new ElevatorAutoCommand(elevator, Constants.Elevator.LEVEL_FOUR_POSITION, Constants.CoralPivot.REEF_POSITION));
